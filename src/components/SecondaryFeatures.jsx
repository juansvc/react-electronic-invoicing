...
import screenshotContacts from '@/images/screenshots/factura.png'
import screenshotInventory from '@/images/screenshots/tfacture-lite.png'
import screenshotProfitLoss from '@/images/screenshots/impresion.png'
  ...
  return (
    ...
    >
      <div
        className={clsx(
          'w-9 rounded-lg',
          isActive ? 'bg-pink-500' : 'bg-slate-500'
        )}
      >
