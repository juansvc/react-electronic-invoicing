              ...
              <div className="grid grid-cols-1 lg:grid-cols-3">
                ...
                <div className="relative overflow-hidden bg-slate-900 py-10 px-6 sm:px-10 xl:p-12">
                  ...
                  <p className="mt-6 max-w-3xl text-base text-teal-50">
                    Sucre y Azuay esquina. Edificio Consorcio Médicos. Torre II.<br/><br/>
                    Loja - Ecuador
                  </p>
                ...
                <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                  <h3 className="text-lg font-medium text-warm-gray-900">Déjanos un mensaje</h3>
                    ...
                    <div>
                      ...
                      <div className="mt-1">
                        <input
                          ...
                          className="block w-full rounded-md border-warm-gray-300 py-3 px-4 text-warm-gray-900 shadow-sm focus:border-pink-500 focus:ring-pink-500"
                        />
                      </div>
                    </div>
                    <div>
